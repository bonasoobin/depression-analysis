...
box = final_data.boxplot(column=['age'])
plt.show()

plt.figure(figsize=(10,20))
box = final_data.boxplot(column=['population'])
plt.show()

plt.figure(figsize=(10,20))
box = final_data.boxplot(column=['stress'])
plt.show()

plt.figure(figsize=(10,20))
box = final_data.boxplot(column=['employment'])
plt.show()

plt.figure(figsize=(10,20))
box = final_data.boxplot(column=['covid'])
plt.show()

plt.figure(figsize=(10,20))
box = final_data.boxplot(column=['budget'])
plt.show()

plt.figure(figsize=(10,20))
box = final_data.boxplot(column=['public facilities'])
plt.show()

plt.figure(figsize=(10,20))
box = final_data.boxplot(column=['depression'])
plt.show()
...
Robust_X_num = final_data[['population','stress','employment','covid','budget','public facilities','depression']]
...
X_train_standard = standardScaler.fit_transform(final_)